<template>
  ...
  >
    <label class="vk-form-item__label">
      <!-- 重点slot传参 :label="label" -->
      <slot name="label" :label="label">
        {{ label }}
      </slot>
    </label>
    <div class="vk-form-item__content">
      <!-- 重点slot传参 :validate="validate" -->
...
import type { FormItemProps, FormValidateFailure, FormItemContext, FormItemInstance, ValidateStatusProp } from './types';
